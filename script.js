...
// const obsOptions = {
//   root: null,
//   threshold: [0, 0.2], // intersectionRatio so baisicly this activates if section1's 10% is leaving viewport or viewport is erntering in 10% of section1
// };
...
document.querySelector('.nav__links').addEventListener('click', function (e) {
  this.style.backgroundColor = randomColor();
  console.log('kanterineri', e.target, e.currentTarget);
});
